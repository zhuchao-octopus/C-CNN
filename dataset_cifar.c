...
#define CifarFilePathName "cifar-10-batches-bin\\data_batch_1.bin"
...
{
    //return Dataset_GetPic("cifar-10-batches-bin\\test_batch.bin", TestingIndex, DataSetType);
}
/// @brief ///////////////////////////////////////////////////////////////////////
...
{
    if (PCifarFile == NULL)
        PCifarFile = fopen(CifarFilePathName, "rb");
    if (PCifarFile != NULL)
        return Dataset_GetPic(PCifarFile, TrainningIndex, DataSetType);
    else
        return NULL;
}
/// @brief /////////////////////////////////////////////////////////////////////////
...
{
    uint32_t offset = CIFAR10_IMAGE_SIZE * ImageIndex;
    return ReadFile2(PFile, Buffer, CIFAR10_IMAGE_SIZE, offset);
}
/// @brief ////////////////////////////////////////////////////////////////////////
/// @param FileName
/// @param Buffer
